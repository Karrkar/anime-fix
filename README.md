...
CI (typecheck + тесты + аудит + сборка) запускается на каждый пуш/PR.
Репозиторий публичный; секретов в коде нет — все ключи в env Vercel.

Автодеплой проверен: 2026-09-23.
